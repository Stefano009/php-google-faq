    ...
    <?php 
        ...
        $faqs = [
            ...
            [
                ...
                [
                "paragraph" => "Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla società consociata che li offre o dal paese a cui è associato il tuo account."
                ]
            ],
            [
            ...
            foreach ($faqs as $faq) 
                foreach($faq as $keys => $element) {
                    if($keys === 'Q') 
                        echo '<h2>' . $element . '</h2>';
                    foreach ($element as $singleKey => $item) {
                        if(!is_numeric($singleKey)){
                            if($singleKey === 'paragraph')
                                echo '<p>' . $item . '</p>';
                            elseif($singleKey === 'list') 
                            {
                                echo '<ol>';
                                echo $item;
                                echo '</ol>'; 
